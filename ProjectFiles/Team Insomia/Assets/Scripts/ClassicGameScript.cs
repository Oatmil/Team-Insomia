...
public class ClassicGameScript : MonoBehaviour
{
    ...
    public int Round = 0;
    [HideInInspector]
    public int RoundAnnouncement = 1;
    [HideInInspector]
    public int MatchEnding = 2;
    [HideInInspector]
    public int RoundConfirmation = 3;
    [HideInInspector]
    public int ReadyPhase = 4;
    [HideInInspector]
    ...
    void ReadyMatch()
    {
        //! change timer from round announcement
        //! in StartGameOnTouch add counter in OnTouchDown and minus counter in Ontouchup
        //! touchcounter compare with jester counter to change phase;
    }
    ...
    void Update()
    {
        ...
        {
            if (currentPhase == ReadyPhase)
                ReadyMatch();
            else if (currentPhase == RoundAnnouncement)
                AnnounceRound();
